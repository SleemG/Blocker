...
class CreateFocusModeDialog(QDialog):
    ...
    def add_apps(self):
        ...
        if hasattr(self.parent(), 'get_installed_apps'):
            ...
            # Use the same AppSelectionDialog from main window
            from . import main_window
            dialog = main_window.AppSelectionDialog(apps, self)
            ...
            if dialog.exec_() == QDialog.Accepted:
                ...
                for item in selected_items:
                    ...
                    if app_path not in existing_items:
                        self.allowedApps_lstWdgt.addItem(app_path)
        else:
